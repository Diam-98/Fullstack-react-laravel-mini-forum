...
const AuthModals = ({open, setOpen}) => {
        ...
        if(switchForm == 1){
            ...
            UserApi.login(values).then((response)=>{
                ...
                if(error.response.status == 400){
                    message.error("Login ou mot de passe inccorect")
                }
    ...
    const onFinishFailed = () => {
        message.error("Remplisser d'abord le formulaire")
    }
        ...
        >
            {switchForm == 1 && 
                <>
                    ...
                    <p>Pas de compte ?
                        <Button type='link' onClick={registerForm}>Creer</Button>
                    </p>
                </>
            }
                ...
                <>
                    <Form.Item
                        ...
                        rules={[
                            {
                                required: true,
                                message: 'Entrez votre prenom et nom'
                            }
                        ]}>
                            <Input/>
                    </Form.Item>
                    ...
                    <Form.Item
                        ...
                        >
                            <Upload listType='picture'>
                                <Button icon={<UploadOutlined/>}>Telecharger une Image</Button>
                            </Upload>
                    </Form.Item>
